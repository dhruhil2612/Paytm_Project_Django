...
# change the file name crypto to Crypto with 
# upper case C because they import it as Crypto in every package.
# in my case E:\PYTHON_DJANGO_PROJECTS\myenv\Lib\site-packages\Crypto
